            ...
            return <form onSubmit={validateSignUp} id={disease.medicalHistoryId} key={index}>
                <div>
                    ...
                    <div>
                        ...
                        <input id={disease.medicalHistoryId+'-'+index+'-startDate'} value={medicalHistory[index]['startDate'] } onChange={handleInputChange} type="date" className="startDate" max={getTodaysDate()}/>
                    </div>
                    <div>
