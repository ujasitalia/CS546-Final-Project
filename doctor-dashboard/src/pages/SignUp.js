...
const SignUp = () => {
  ...
  const handleInputChange = (e) => {
    ...
    else if (e.target.id === "signUpPassword") setPassword(e.target.value);
    else if (e.target.id === "signUpRepassword") setRepassword(e.target.value);
    else if (e.target.id === "signUpSpeciality") setSpeciality(e.target.value);
    else if (e.target.id === "signUpName") setName(e.target.value);
    else if (e.target.id === "signUpZip") setZip(e.target.value);
    ...
    <div>
      ...
      <div className="loginCard">
        <form onSubmit={validateSignUp}>
          ...
          <input
            placeholder="1 Castle point"
            id="signUpClinicAddress"
            value={clinicAddress}
            onChange={handleInputChange}
            type="text"
            className="loginInput"
